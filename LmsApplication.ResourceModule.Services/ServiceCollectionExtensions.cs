...
{
    public static IServiceCollection AddResourceModuleServices(this IServiceCollection services, IConfiguration config)
    {
        ...
        services.AddScoped<BlobContainerClient>(_ => new BlobContainerClient(config.GetConnectionString("BlobStorage"), "resources"));
